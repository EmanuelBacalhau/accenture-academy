...
public class Activity3 {
  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      boolean isOld = Activity3.checkIsOld(board);
      ...
      if (!isOld) {
        ...
        if (Activity3.isValidMove(board, line, col)) {
          Activity3.makeMove(board, line, col, roundPlayer);

          boolean isWinner = Activity3.checkColWinner(board) || Activity3.checkLineWinner(board)
              || Activity3.checkDiagonalWinner(board);

          if (isWinner) {
            Activity3.printBoard(board);
